...
<body>
    <form id="form1" runat="server">
        <br />
        <asp:Button ID="btnStock" runat="server" OnClick="btnStock_Click" style="z-index: 1; left: 236px; top: 228px; position: absolute; height: 60px; width: 186px; right: 985px;" Text="Stock" Font-Bold="True" Font-Size="20pt" />
